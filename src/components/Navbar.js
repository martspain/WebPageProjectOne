/*
El dropdown interactivo (funciona a través de un hover) fue implementado en base al codigo provisto por vosidiy
en la siguiente link: https://bootstrap-menu.com/detail-basic-hover.html 
*/
    ...
    return(
        <nav className="navbar navbar-expand-lg navbar-custom">
            <div className="navbar-brand epic-logo" href="/UnrealEngine">
                <img src={ epicLogo } width="30" height="35" alt="EpicLogo"></img>
            </div>
            <div className="collapse navbar-collapse">
                <div className="navbar-nav">
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link  dropdown-toggle subtitulo" href="#" data-bs-toggle="dropdown">ABOUT</a>
                        <ul className="dropdown-menu">
                            <li><a className="dropdown-item item-hover-dropdown" href="/features">FEATURES</a></li>
                            <li><a className="dropdown-item item-hover-dropdown" href="/whatsnew">WHAT'S NEW</a></li>
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link  dropdown-toggle subtitulo" href="#" data-bs-toggle="dropdown">INDUSTRIES</a>
                        <ul className="dropdown-menu">
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link  dropdown-toggle subtitulo" href="#" data-bs-toggle="dropdown">LEARNING & SUPPORT</a>
                        <ul className="dropdown-menu">
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link  dropdown-toggle subtitulo" href="#" data-bs-toggle="dropdown">COMMUNITY</a>
                        <ul className="dropdown-menu">
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link  dropdown-toggle subtitulo" href="#" data-bs-toggle="dropdown">MARKET PLACE</a>
                        <ul className="dropdown-menu">
                    ...
                    <input type="image" className="search-icon" src={searchIcon} alt="Search" width="30" height="30"></input>
                    <li className="nav-item dropdown">
                        <input type="image" className="nav-link  dropdown-toggle global-icon" src={languageIcon} alt="Language" width="35" height="35"></input>
                        <ul className="dropdown-menu">
                    ...
                    <input type="image" className="login-icon" src={loginIcon} alt="Login" width="30" height="30"></input>
